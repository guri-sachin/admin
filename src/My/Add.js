         ...
         {/*  <!-- Page Heading --> */}
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <form class="col-md-9">
                ...
                <Form.Control type="text" placeholder="enter product name" onChange={handelDemo1} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Product Price</Form.Label>
                <Form.Control type="text" placeholder="enter product price" onChange={handelDemo2} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Product SKU</Form.Label>
                <Form.Control type="text" placeholder="enter product sku" onChange={handelDemo4} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Sale Percentage</Form.Label>
                <Form.Control type="text" placeholder="enter Sale Percentage" onChange={handelDemo5} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Sale Price</Form.Label>
                <Form.Control type="text" placeholder="enter Sale Price" onChange={handelDemo6} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Inventery</Form.Label>
                <Form.Control type="text" placeholder="Inventery in numbers" onChange={handelDemo8} />
                </Form.Group>
