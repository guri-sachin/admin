         ...
         {/*  <!-- Page Heading --> */}
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <form class="col-md-9" onSubmit={(event) => event.preventDefault()}>
                ...
                <Form.Control type="text" placeholder="Coupan Code" onChange={handelDemo1} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Minimum Amount</Form.Label>
                <Form.Control type="text" placeholder="Minimum Amount in Card" onChange={handelDemo2} />
                </Form.Group>

                <div class="input-group">
  <input type="text" class="form-control" placeholder="Off amount" aria-label="Amount (to the nearest dollar)" onChange={handelDemo3}/>
  <div class="input-group-append">
