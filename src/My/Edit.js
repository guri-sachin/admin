         ...
         {/*  <!-- Page Heading --> */}
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <form class="col-md-9">
                ...
                <Form.Control type="text"   onChange={handelDemo1} value={name} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Product Price</Form.Label>
                <Form.Control type="text" value={price}  onChange={handelDemo5}/>
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Product SKU</Form.Label>
                <Form.Control type="text" value={sku} onChange={handelDemo4} />
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Sale Percentage</Form.Label>
                <Form.Control type="text" value={percentage} onChange={handelDemo6}/>
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Sale Price</Form.Label>
                <Form.Control type="text" value={sale}  onChange={handelDemo2}/>
                </Form.Group>

                <Form.Group className="mb-3" controlId="formBasicEmail">
                <Form.Label>Inventery</Form.Label>
                <Form.Control type="text" value={Inventery} onChange={handelDemo8}/>
                </Form.Group>
...
<Form.Group className="mb-3" controlId="formBasicEmail">
                ...
                <Form.Control type="text" value={sub} onChange={handelDemo12} />
                </Form.Group>
